...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<c:url value="/students/add" var="save"></c:url>
			<div class="col-lg-6 col-md-9 col-sm-12">
				<sf:form method="post" action="${save}" modelAttribute="form">
					<h2 class="my-4">
						<i class="bi-plus-lg"></i> Add New Student
					</h2>
					...
					<div class="row">
						<div class="col">
							<div class="mb-3">
								...
								<sf:errors path="realId" cssClass="alert alert-warning"
						...
						<div class="col">
							<div class="mb-3">
								...
								<sf:errors path="name" cssClass="alert alert-warning"
									element="div"></sf:errors>
					...
					<div class="mb-3">
						...
						<sf:errors path="phone" cssClass="alert alert-warning"
							element="div"></sf:errors>
					...
					<div class="mb-3">
						...
						<sf:errors path="email" cssClass="alert alert-warning"
							element="div"></sf:errors>
					...
					<div class="mb-3">
						...
						<sf:errors path="assignDate" cssClass="alert alert-warning"
							element="div"></sf:errors>
